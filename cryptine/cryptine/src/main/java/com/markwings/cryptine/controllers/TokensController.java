...
public class TokensController {
    ...
    public ResponseEntity<Token> addToken(@ModelAttribute Token token, @RequestPart MultipartFile image)
            throws IOException {
    ...
    public ResponseEntity<Token> updateToken(@RequestPart Token token, @RequestPart MultipartFile image)
            throws IOException {
        tokenServices.addToken(token, image);
